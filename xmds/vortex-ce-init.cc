...
// ********************************************************
//   Geometry defines
#define _lattice_r ((int)256)
#define _min_r     (_r[0])
#define _max_r     (_r[_lattice_r-1])

#define _lattice_kr ((int)256)
#define _min_kr     (_kr[0])
#define _max_kr     (_kr[_lattice_kr-1])

#define _lattice_z ((int)256)
#define _min_z     ((real)-30)
#define _max_z     ((real)30)
#define _dz        ((real)((_max_z - _min_z)/_lattice_z))

#define _lattice_kz ((int)256)
...
#define _mg0_output_lattice_t ((int)21)
...
#define _mg1_output_lattice_t ((int)21)
...
#define _mg2_output_lattice_t ((int)21)
...
const real _normbesseljzeros_r[] = {
  0.00474118791655148, 0.008680784748378821, 0.012588211247526565,
  0.016486162483100524, 0.020380048151497805, 0.024271818366475243,
  0.02816234802043396, 0.03205208803886299, 0.035941294435082205,
  0.03983012334928886, 0.043718675421033436, 0.04760701843585431,
  0.05149519971990296, 0.055383253317125465, 0.05927120434326736,
  0.06315907173256127, 0.06704687002921023, 0.07093461058998064,
  0.0748223024120126, 0.07870995271538332, 0.08259756736120047,
  0.08648515115696256, 0.09037270808312406, 0.0942602414636077,
  0.0981477540958024, 0.10203524835084928, 0.10592272625184794,
  0.10981018953545357, 0.1136976397008394, 0.11758507804894819,
  0.12147250571420774, 0.12535992369034618, 0.12924733285154907,
  0.13313473396991013, 0.137022127729912, 0.1409095147405102,
  0.1447968955452705, 0.14868427063091655, 0.15257164043457064,
  0.15645900534991525, 0.1603463657324583, 0.1642337219040508,
  0.16812107415677774, 0.17200842275632133, 0.17589576794487852,
  0.17978310994369975, 0.18367044895530557, 0.18755778516542754,
  0.1914451187447125, 0.19533244985022383, 0.1992197786267663,
  0.2031071052080593, 0.2069944297177778, 0.21088175227047784,
  0.21476907297242198, 0.2186563919223164, 0.22254370921197084,
  0.22643102492689055, 0.23031833914680835, 0.23420565194616366,
  0.23809296339453453, 0.24198027355702822, 0.24586758249463458,
  0.24975489026454642, 0.2536421969204505, 0.25752950251279216,
  0.2614168070890163, 0.26530411069378723, 0.2691914133691893,
  0.2730787151549106, 0.27696601608841126, 0.28085331620507736,
  0.2847406155383628, 0.28862791411991906, 0.29251521197971536,
  0.2964025091461487, 0.3002898056461456, 0.3041771015052563,
  0.30806439674774133, 0.3119516913966521, 0.315838985473905,
  0.3197262790003508, 0.32361357199583823, 0.32750086447927385,
  0.331388156468677, 0.33527544798123127, 0.3391627390333326,
  0.34305002964063375, 0.34693731981808595, 0.35082460957997774,
  0.35471189893997135, 0.3585991879111366, 0.36248647650598265,
  0.3663737647364878, 0.37026105261412734, 0.37414834014989967,
  0.3780356273543507, 0.3819229142375972, 0.385810200809348,
  0.38969748707892476, 0.39358477305528067, 0.3974720587470188,
  0.4013593441624088, 0.4052466293094033, 0.40913391419565237,
  0.41302119882851823, 0.4169084832150886, 0.4207957673621891,
  0.42468305127639555, 0.4285703349640453, 0.4324576184312476,
  0.4363449016838942, 0.4402321847276687, 0.44411946756805565,
  0.4480067502103493, 0.4518940326596617, 0.45578131492093066,
  0.45966859699892665, 0.46355587889826044, 0.4674431606233892,
  0.4713304421786232, 0.4752177235681316, 0.47910500479594825,
  0.4829922858659773, 0.48687956678199795, 0.49076684754766986,
  0.4946541281665376, 0.49854140864203517, 0.5024286889774903,
  0.5063159691761285, 0.5102032492410771, 0.5140905291753687,
  0.5179778089819448, 0.5218650886636595, 0.5257523682232824,
  0.5296396476635018, 0.5335269269869274, 0.5374142061960937,
  0.5413014852934623, 0.5451887642814247, 0.5490760431623045,
  0.5529633219383598, 0.5568506006117863, 0.5607378791847181,
  0.5646251576592308, 0.5685124360373435, 0.5723997143210199,
  0.5762869925121712, 0.5801742706126571, 0.584061548624288,
  0.5879488265488264, 0.5918361043879882, 0.5957233821434447,
  0.5996106598168239, 0.603497937409712, 0.6073852149236544,
  0.611272492360157, 0.6151597697206881, 0.6190470470066788,
  0.6229343242195244, 0.6268216013605858, 0.6307088784311905,
  0.634596155432633, 0.6384834323661768, 0.6423707092330542,
  0.6462579860344685, 0.6501452627715938, 0.6540325394455764,
  0.6579198160575356, 0.6618070926085642, 0.6656943690997297,
  0.6695816455320747, 0.6734689219066177, 0.6773561982243539,
  0.6812434744862557, 0.6851307506932734, 0.6890180268463361,
  0.6929053029463517, 0.6967925789942081, 0.7006798549907736,
  0.7045671309368967, 0.7084544068334082, 0.71234168268112,
  0.7162289584808268, 0.7201162342333058, 0.7240035099393181,
  0.7278907855996078, 0.7317780612149037, 0.7356653367859192,
  0.7395526123133521, 0.7434398877978865, 0.7473271632401917,
  0.7512144386409231, 0.7551017140007228, 0.7589889893202199,
  0.7628762646000302, 0.7667635398407576, 0.7706508150429934,
  0.7745380902073171, 0.7784253653342967, 0.782312640424489,
  0.7861999154784395, 0.7900871904966831, 0.7939744654797444,
  0.7978617404281376, 0.801749015342367, 0.805636290222927,
  0.8095235650703028, 0.81341083988497, 0.8172981146673953,
  0.8211853894180368, 0.8250726641373436, 0.8289599388257565,
  0.8328472134837079, 0.8367344881116228, 0.8406217627099175,
  0.8445090372790013, 0.8483963118192754, 0.8522835863311343,
  0.856170860814965, 0.8600581352711474, 0.8639454097000547,
  0.8678326841020536, 0.8717199584775039, 0.8756072328267593,
  0.8794945071501672, 0.8833817814480687, 0.887269055720799,
  0.8911563299686874, 0.895043604192058, 0.8989308783912284,
  0.9028181525665115, 0.9067054267182144, 0.9105927008466392,
  0.9144799749520826, 0.9183672490348365, 0.9222545230951877,
  0.9261417971334186, 0.9300290711498063, 0.9339163451446235,
  0.9378036191181386, 0.9416908930706154, 0.9455781670023132,
  0.9494654409134875, 0.9533527148043891, 0.957239988675265,
  0.9611272625263584, 0.9650145363579081, 0.9689018101701495,
  0.972789083963314, 0.9766763577376293, 0.9805636314933198,
  0.984450905230606, 0.9883381789497049, 0.9922254526508305,
  0.9961127263341931
  };
const real _besseljnorm_r = 808.17424612743826833893834304944903124;
...
int main(int argc, char **argv)
{
    ...
    #if __MAC_OS_X_VERSION_MIN_REQUIRED >= 1080
  {
    ...
    IOReturn __io_result = IOPMAssertionCreateWithDescription(
      ...
      CFSTR("XMDS simulation 'vortex-ce-init' preventing user idle sleep"), // Assertion name
  ...
  while (1) {
    ...
    resp = getopt_long(argc, argv, "hm:g:l:x:R:Z:A:", long_options, &option_index);
  ...
  for (long _index_kr = 0; _index_kr < _lattice_kr; _index_kr++) {
    ...
    const real kr_max = (_besseljnorm_r/((real)30));
...
void _print_usage()
{
  ...
  _LOG(_NO_ERROR_TERMINATE_LOG_LEVEL, "\n\nUsage: vortex-ce-init --mu <real> --g <real> --lamb <real> --xi <real> --R <real> --Z <real> --A <real>\n\n"
                         "Details:\n"
...
void _rz_init_initialise()
{
  ...
  #ifdef _OPENMP
  #pragma omp parallel for firstprivate(__initialised) private(_rz_init_index_pointer)
  #endif
  ...
  for (long _index_r = 0; _index_r < _lattice_r; _index_r++) {
    if (!__initialised) {
      _rz_init_index_pointer = _index_r * _local_swapped_lattice_z * _rz_init_ncomponents;
      __initialised = true;
    }
    ...
    for (long _index_z = 0; _index_z < _local_swapped_lattice_z; _index_z++) {
      ...
      // ********** Initialisation code ***************
      #line 38 "vortex-ce-init.xmds"
      
      if ((1 - r*r/(R*R) - z*z/(Z*Z)) > 0) {
         DI = A*sqrt(r*r/(r*r+xi*xi))*sqrt(1-r*r/(R*R)-z*z/(Z*Z));
         // This will be automatically normalised later
       } else {
         DI = 0.0;
       }
      #line 1637 "vortex-ce-init.cc"
      // **********************************************
      #undef t
...
void _rz_main_initialise()
{
  ...
  bool __initialised = false;
  #ifdef _OPENMP
  #pragma omp parallel for firstprivate(__initialised) private(_rz_init_index_pointer, _rz_main_index_pointer)
  #endif
  #define r _r[_index_r + 0]
  #define dr (_dr_array[_index_r + 0] * (1.0))
  ...
  for (long _index_r = 0; _index_r < _lattice_r; _index_r++) {
    if (!__initialised) {
      _rz_init_index_pointer = _index_r * _local_swapped_lattice_z * _rz_init_ncomponents;
      _rz_main_index_pointer = _index_r * _local_swapped_lattice_z * _rz_main_ncomponents;
      __initialised = true;
    }
    #define z _z[_index_z + _local_swapped_offset_z]
    #define dz (_dz * (1.0))
    ...
    for (long _index_z = 0; _index_z < _local_swapped_lattice_z; _index_z++) {
      ...
      // ********** Initialisation code ***************
      #line 54 "vortex-ce-init.xmds"
      
      D = DI;
      #line 1688 "vortex-ce-init.cc"
      // **********************************************
      #undef t
...
void _dimensionless_normalisation_evaluate()
{
  ...
  for (long _index_r = 0; _index_r < _lattice_r; _index_r++) {
    ...
    for (long _index_z = 0; _index_z < _local_swapped_lattice_z; _index_z++) {
      // ************* Evaluation code ****************
      #line 65 "vortex-ce-init.xmds"
      
      // Calculate the current normalisation of the wave function.
      Ncalc = 2.0*M_PI*mod2(D);
      #line 1776 "vortex-ce-init.cc"
      // **********************************************
...
real _segment1_setup_sampling(bool* _next_sample_flag, long* _next_sample_counter)
{
   ...
   */
  if (_next_sample_counter[0] * _previous_M == _previous_m * 20) {
    _momentGroupNumbersNeedingSamplingNext[_numberOfMomentGroupsToBeSampledNext] = 0;
    _numberOfMomentGroupsToBeSampledNext++;
  } else if (_next_sample_counter[0] * _previous_M < _previous_m * 20) {
    _t_break_next = _next_sample_counter[0] * ((real)10.0) / ((real)20);
  ...
  if (_next_sample_counter[1] * _previous_M == _previous_m * 20) {
    _momentGroupNumbersNeedingSamplingNext[_numberOfMomentGroupsToBeSampledNext] = 1;
    _numberOfMomentGroupsToBeSampledNext++;
  } else if (_next_sample_counter[1] * _previous_M < _previous_m * 20) {
    _t_break_next = _next_sample_counter[1] * ((real)10.0) / ((real)20);
    _numberOfMomentGroupsToBeSampledNext = 1;
  ...
  if (_next_sample_counter[2] * _previous_M == _previous_m * 20) {
    _momentGroupNumbersNeedingSamplingNext[_numberOfMomentGroupsToBeSampledNext] = 2;
    _numberOfMomentGroupsToBeSampledNext++;
  } else if (_next_sample_counter[2] * _previous_M < _previous_m * 20) {
    _t_break_next = _next_sample_counter[2] * ((real)10.0) / ((real)20);
    _numberOfMomentGroupsToBeSampledNext = 1;
...
real _segment1_rz_main_timestep_error(complex* _checkfield)
{
  ...
  
  {
    ...
    bool __initialised = false;
    #ifdef _OPENMP
    #pragma omp parallel for firstprivate(__initialised) private(_rz_main_index_pointer)
    #endif
    for (long _i0 = 0; _i0 < (_lattice_r * _local_swapped_lattice_z); _i0++) {
      if (!__initialised) {
        _rz_main_index_pointer = _i0 * _rz_main_ncomponents;
        __initialised = true;
      }
...
void _segment1_rz_operators_evaluate_operator0()
{
  ...
  bool __initialised = false;
  #ifdef _OPENMP
  #pragma omp parallel for firstprivate(__initialised) private(_rz_segment1_rz_operators_operator0_result_index_pointer, _rz_main_index_pointer, _rz_segment1_rz_operators_operator0_field_index_pointer)
  #endif
  for (long _i0 = 0; _i0 < (_lattice_kz * _local_unswapped_lattice_kr); _i0++) {
    if (!__initialised) {
      _rz_segment1_rz_operators_operator0_result_index_pointer = _i0 * _rz_segment1_rz_operators_operator0_result_ncomponents;
      _rz_main_index_pointer = _i0 * _rz_main_ncomponents;
      _rz_segment1_rz_operators_operator0_field_index_pointer = _i0 * _rz_segment1_rz_operators_operator0_field_ncomponents;
      __initialised = true;
    }
    // Lzz[D]
    _Lzz_D = Lzz * D;
...
void _segment1_rz_operators_calculate_operator0_field()
{
  ...
  bool __initialised = false;
  #ifdef _OPENMP
  #pragma omp parallel for firstprivate(__initialised) private(_rz_segment1_rz_operators_operator0_field_index_pointer)
  #endif
  ...
  for (long _index_kz = 0; _index_kz < _lattice_kz; _index_kz++) {
    if (!__initialised) {
      _rz_segment1_rz_operators_operator0_field_index_pointer = _index_kz * _local_unswapped_lattice_kr * _rz_segment1_rz_operators_operator0_field_ncomponents;
      __initialised = true;
    }
    ...
    for (long _index_kr = 0; _index_kr < _local_unswapped_lattice_kr; _index_kr++) {
      // ************** Operator code *****************
      #line 79 "vortex-ce-init.xmds"
      
      Lrr = - kr*kr;
      Lzz = - kz*kz;
      #line 2482 "vortex-ce-init.cc"
      // **********************************************
      // Increment index pointers for vectors in field rz (or having the same dimensions)
...
void _segment1_rz_operators_evaluate_operator1(real _step)
{
  ...
  bool __initialised = false;
  #ifdef _OPENMP
  #pragma omp parallel for firstprivate(__initialised) private(_rz_segment1_rz_operators_operator0_result_index_pointer, _rz_main_index_pointer)
  #endif
  #define r _r[_index_r + 0]
  #define dr (_dr_array[_index_r + 0] * (1.0))
  ...
  for (long _index_r = 0; _index_r < _lattice_r; _index_r++) {
    if (!__initialised) {
      _rz_segment1_rz_operators_operator0_result_index_pointer = _index_r * _local_swapped_lattice_z * _rz_segment1_rz_operators_operator0_result_ncomponents;
      _rz_main_index_pointer = _index_r * _local_swapped_lattice_z * _rz_main_ncomponents;
      __initialised = true;
    }
    #define z _z[_index_z + _local_swapped_offset_z]
    ...
    for (long _index_z = 0; _index_z < _local_swapped_lattice_z; _index_z++) {
      ...
      // ************* Propagation code ***************
      #line 85 "vortex-ce-init.xmds"
      
      dD_dt = i*(0.5*(_Lrr_D + _Lzz_D) - (0.5*(r*r + lamb*lamb*z*z)*D) - ((4.0*M_PI*g*mod2(D) - mu)*D));
      #line 2574 "vortex-ce-init.cc"
      // **********************************************
...
void _write_output()
{
  _LOG(_SIMULATION_LOG_LEVEL, "Generating output for vortex-ce-init\n");
  
  
  char *_xsilFilename = (char*)malloc(256);
  snprintf(_xsilFilename, 256, "%s.xsil", ("vortex-ce-i" + gsArgsAndValues).c_str());
  ...
  if (_outfile) {
    ...
    snprintf(_dataFilename, 200, "%s.h5", ("vortex-ce-i" + gsArgsAndValues).c_str());
...
void _write_xsil_header(FILE* fp)
{
  ...
  fprintf(fp, "      <dimension name=\"r\" lattice=\"256\"  domain=\"(0, 30)\" transform=\"bessel\" order=\"1\" />\n");
  fprintf(fp, "      <dimension name=\"z\" lattice=\"256\"  domain=\"(-30, 30)\" />\n");
  fprintf(fp, "    </transverse_dimensions>\n");
  fprintf(fp, "  </geometry>\n");
  fprintf(fp, "\n");
  fprintf(fp, "    \n");
  ...
  fprintf(fp, "          DI = A*sqrt(r*r/(r*r+xi*xi))*sqrt(1-r*r/(R*R)-z*z/(Z*Z));\n");
  ...
  fprintf(fp, "  <sequence>\n");
  fprintf(fp, "    \n");
  fprintf(fp, "    <integrate algorithm=\"ARK45\" tolerance=\"1e-5\" interval=\"10.0\" steps=\"100000\">\n");
  fprintf(fp, "      <samples>20 20 20</samples>\n");
  ...
  fprintf(fp, "         <![CDATA[\n");
  fprintf(fp, "                dD_dt = i*(0.5*(Lrr[D] + Lzz[D]) - (0.5*(r*r + lamb*lamb*z*z)*D) - ((4.0*M_PI*g*mod2(D) - mu)*D));\n");
  fprintf(fp, "        ]]>\n");
  fprintf(fp, "      </operators>\n");
  fprintf(fp, "    </integrate>\n");
  fprintf(fp, "  </sequence>\n");
  fprintf(fp, "\n");
  fprintf(fp, "  <output format=\"hdf5\" filename=\"vortex-ce-i.xsil\">      \n");
  ...
  fprintf(fp, "        <![CDATA[\n");
  fprintf(fp, "            \n");
  fprintf(fp, "          Dz = 2.0*M_PI*z*z*mod2(D);\n");
  fprintf(fp, "            \n");
  fprintf(fp, "        ]]>\n");
  fprintf(fp, "      </sampling_group>\n");
  fprintf(fp, "    \n");
  ...
  fprintf(fp, "  Command line argument xi = %e\n", xi);
...
void _mg0_sample()
{
  ...
  for (long _index_r = 0; _index_r < _lattice_r; _index_r++) {
    ...
    for (long _index_z = 0; _index_z < _local_swapped_lattice_z; _index_z++) {
      ...
      // *************** Sampling code ****************
      #line 96 "vortex-ce-init.xmds"
      
      
      Dr = 2.0*M_PI*r*r*mod2(D);
      
      #line 2844 "vortex-ce-init.cc"
      // **********************************************
...
void _mg0_write_out(FILE* _outfile)
{
  ...
  if (_rank == 0) {
    ...
    snprintf(_h5Filename, 200, "%s.h5", ("vortex-ce-i" + gsArgsAndValues).c_str());
    ...
    if (_outfile) {
      ...
      fprintf(_outfile, "%s.h5\n", ("vortex-ce-i" + gsArgsAndValues).c_str());
      fprintf(_outfile, "    </Stream>\n");
    }
...
void _mg1_sample()
{
  ...
  for (long _index_r = 0; _index_r < _lattice_r; _index_r++) {
    ...
    for (long _index_z = 0; _index_z < _local_swapped_lattice_z; _index_z++) {
      ...
      // *************** Sampling code ****************
      #line 106 "vortex-ce-init.xmds"
      
      
      Dz = 2.0*M_PI*z*z*mod2(D);
      
      #line 3028 "vortex-ce-init.cc"
      // **********************************************
...
void _mg2_sample()
{
  ...
  for (long _index_r = 0; _index_r < _lattice_r; _index_r++) {
    ...
    for (long _index_z = 0; _index_z < _local_swapped_lattice_z; _index_z++) {
      ...
      // *************** Sampling code ****************
      #line 116 "vortex-ce-init.xmds"
      
      
      Dn = 2.0*M_PI*mod2(D);
      
      #line 3212 "vortex-ce-init.cc"
      // **********************************************
